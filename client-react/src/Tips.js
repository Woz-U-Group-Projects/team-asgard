      ...
      <div className="container">
        ...
        <div className="col-lg-12">
          <div className="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-md h-md-250 position-relative">
            <form action="" method="">
              <label for="userTips"><h2>Got a Tip we missed? Add your own!</h2></label>
              <textarea ref={this.tipsSubmission} placeholder="Enter your tip here!"></textarea>
              <div class="input-group mb-3">
                <input ref={this.userName} placeholder="Username"/>
                <button onClick={this.addTip} className="btn btn-success" type="submit">Submit</button>
              </div>
            </form>
            <table >
              <div>
        ...
        <label>
          Enter Tip: 
          <input ref={this.tipsSubmission} /> <br></br>
        </label>
        <br></br>
